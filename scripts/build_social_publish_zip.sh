...
cp "${ROOT_DIR}/cs2bot/media_cards.py" "${BUILD_DIR}/cs2bot/media_cards.py"
cp -R "${ROOT_DIR}/cs2bot/assets" "${BUILD_DIR}/cs2bot/assets"
cp -R "${ROOT_DIR}/cs2bot/match_sources" "${BUILD_DIR}/cs2bot/match_sources"
