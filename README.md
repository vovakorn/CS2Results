...
матчей. Для Telegram расписание получает отдельную контекстную обложку на каждый
турнир и формат; короткий одиночный контекст прикрепляется к ней подписью.
