...
DEFAULT_TEAM_ALIASES = {
    ...
    "g2 esports": "g2",
    "g2": "g2",
    "phantom esports": "phantom",
    "phantom": "phantom",
    "prestige esport": "prestige",
    "prestige": "prestige",
    "astral esports": "astral",
    "astral": "astral",
    "inner circle esports": "inner circle",
    "ic esports": "inner circle",
...
ENABLE_LIQUIPEDIA_FALLBACK = _bool_env("ENABLE_LIQUIPEDIA_FALLBACK", False)
ENABLE_LIQUIPEDIA_SHADOW = _bool_env("ENABLE_LIQUIPEDIA_SHADOW", False)
ENABLE_LIQUIPEDIA_FINAL_CARDS = _bool_env("ENABLE_LIQUIPEDIA_FINAL_CARDS", False)
...
LIQUIPEDIA_SHADOW_TIMEOUT_SECONDS = _int_setting(
    "LIQUIPEDIA_SHADOW_TIMEOUT_SECONDS",
    5,
    minimum=1,
)
